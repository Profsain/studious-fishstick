...
import OtpVerify from './scenes/otpverify'; // Import the OtpVerify component
  ...
  return (
    <ColorModeContext.Provider value={colorMode}>
      <ThemeProvider theme={theme}>
        <CssBaseline />
        <div className="app">
          {/* Only render Sidebar and Topbar if not on the login route */}
          <Routes>
            <Route path="/login" element={<Login />} />
            <Route path="/verify" element={<OtpVerify />} />
            
            {/* Render Sidebar and Topbar for other routes */}
            <Route path="*" element={
              <>
