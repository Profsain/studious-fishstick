...
import { emailNotificationsData } from "../../data/mockData";
...
const EmailNotification = () => {
  ...
  const filteredRows = emailNotificationsData.filter((row) =>
    ...
    <Box m="20px">
      <Grid container spacing={2} alignItems="flex-start">
        ...
        <Modal
          ...
          aria-labelledby="view-email-notification-modal" 
          aria-describedby="view-notification-details" 
        >
          <Box sx={style}>
            {selectedNotification && (
              <div>
                <Typography id="view-email-notification-modal" variant="h6" component="h2">
                  Email Notification Details
                </Typography>
                <Typography id="view-notification-details" sx={{ mt: 2 }}>
                  <strong>Date:</strong> {selectedNotification.date}<br />
                  <strong>Subject:</strong> {selectedNotification.subject}<br />
