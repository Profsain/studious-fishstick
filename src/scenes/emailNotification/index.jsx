...
import { emailNotificationsData } from "../../data/mockData"; // Import mock data
    ...
    <Box m="20px">
      ...
      <TableContainer component={Paper} sx={{ mt: '20px' }}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          ...
          <TableBody>
            {emailNotificationsData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((notification) => (
      ...
      <TablePagination 
        component="div"
        count={emailNotificationsData.length}
        page={page}
